========================================================================
		ActiveX Control DLL : FTP
========================================================================

ControlWizard has created this project for your FTP ActiveX Control
...
that make up your FTP ActiveX Control DLL.
...
FtpCtl.h
	This file contains the declaration of the CFtpCtrl C++ class.

FtpCtl.cpp
	This file contains the implementation of the CFtpCtrl C++ class.

FtpPpg.h
	This file contains the declaration of the CFtpPropPage C++ class.

FtpPpg.cpp
	This file contains the implementation of the CFtpPropPage C++ class.

FtpCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CFtpCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Ftp.rc.
